    ...
    <div class="col-md-12 col-sm-5">
      <div class="tabs-left">
                                <ul class="nav tarmacdashboard nav-tabs">
                                                ...
                                                <li><a href="#d" data-toggle="tab"><span class="glyphicon glyphicon-open"></span>Quote</a></li>
                                                <li><a href="#e" data-toggle="tab"><span class="glyphicon glyphicon-shopping-cart"></span>Orders</a></li>
